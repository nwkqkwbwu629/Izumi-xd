...
let title = "𝗜𝗭𝗨𝗠𝗜-𝗫𝗗🧚‍♂️"
let body = ""
let sourceUrl = ""
let mediaUrl = ""
let mediaType = 1
let showAdAttribution = false
let renderLargerThumbnail = true
let thumbnailUrl = "https://i.imgur.com/RJhMi7H.jpeg"
let seconds = "0xbebc74b"
let ptt = true
let fileLength = "100000000"
let text = `𝙸'𝚖  𝚊𝚕𝚒𝚟𝚎 🛹`
let videos =  ["https://graph.org/file/1ec6289c1b56b183a9b70.mp4"] // multiple url supported
let images =  ["https://i.imgur.com/RJhMi7H.jpeg"] // multiple url supported
let caption = `𝙷𝚎𝚢 🌸\n𝙸'𝚖  𝚊𝚕𝚒𝚟𝚎 🛹`
let audios = ["https://graph.org/file/1ec6289c1b56b183a9b70.mp4"] // multiple url supported
let stickers =  ["https://i.imgur.com/RJhMi7H.jpeg"] // multiple url supported
let gifPlayback = true

// select the type👇🏿
let type = "video" // image | audio | video | sticker | text
